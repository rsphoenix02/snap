...
// Verbatim from ui_components/globe.md, with onRender removed (cobe v2 dropped it)
...
export function Globe({
  ...
  // Same logic as original onRender callback, now applied via globe.update() (cobe v2 API)
  ...
  useEffect(() => {
    ...
    // cobe v2: use rAF loop + globe.update() instead of onRender callback
    let frameId: number
    const animate = () => {
